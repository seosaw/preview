...
Promise.all([
	...
	var biomeColours = {
		...
		'Flooded Grasslands & Savannas': '#2e8c9e',
		'Montane Grasslands & Shrublands': '#9c5c86',
		'Dry Forest, Savanna, Shrubland and Grassland': '#e6b84a',
		'Tropical & Subtropical Moist Broadleaf Forests': '#3E8F4C',
	};
	...
	legend.onAdd = function() {
		...
		div.innerHTML += '<i class="circle" style="background: #2C3D2E"></i><span>PSP site</span><br>';
		div.innerHTML += '<i class="circle" style="background: #dcdcdc; opacity: 0.4"></i><span>One-off plot</span><br>';
		return div;
	};
	legend.addTo(map);
